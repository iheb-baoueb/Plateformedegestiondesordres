...
export function MissionTransfert() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log('Mission Transfert créée:', formData);
    navigate('/missions/transfert');
  };
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-semibold text-gray-900">Nouvelle Mission - Transfert</h1>
          <p className="mt-1 text-gray-600">
            Créer une mission de transfert avec heure de vol
          </p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="rounded-lg bg-white p-6 shadow">
        <div className="space-y-6">
          ...
          <div>
            <h3 className="mb-4 text-lg font-medium text-gray-900">Détails du Transfert</h3>
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700">Heure de vol</label>
                <input
                  type="time"
